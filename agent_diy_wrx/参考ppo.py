    ...
    for update in range(1, num_updates + 1):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                _, newlogprobs, entropies, newvalues = agent.get_action_and_value(b_obs[mb_inds], b_actions.long()[mb_inds])
        ...
        # writer.add_scalar("losses/entropies", entropy_loss.item(), global_step)
