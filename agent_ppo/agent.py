...
class Agent(BaseAgent):
    ...
    def observation_process(self, terminated=False, truncated=False, obs=None, extra_info=None, rewardStateTracker = None):
        feature, legal_action, reward = self.preprocessor.process(terminated, truncated, obs, extra_info, rewardStateTracker, [obs, extra_info], self.last_action)
        return ObsData(
            feature=feature,
    ...
    def exploit(self, observation):
        obs_data = self.observation_process(obs=observation["obs"], extra_info=observation["extra_info"])
